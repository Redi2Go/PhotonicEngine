...
uniform sampler2D radiosity_reservoirs_initial;
uniform sampler2D radiosity_reservoirs_spatial_0;
uniform sampler2D radiosity_reservoirs_spatial_1;
uniform sampler2D radiosity_reservoirs_spatial_2;
uniform sampler2D radiosity_reservoirs;
uniform sampler2D radiosity_lighting_raw;
