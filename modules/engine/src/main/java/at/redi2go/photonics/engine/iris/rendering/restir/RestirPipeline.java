...
public class RestirPipeline extends PhotonicsPipeline {
    ...
    private void neighborSelectionPipeline(IrisPipeline irisPipeline) {
        ...
        var framebuffer = irisPipeline.newFramebuffer(properties.getRenderScale(), this::registerComponent)
                .addAttachment("neighbor_reservoir", TextureFormat.RGBA32F, CREATE_SAMPLER)
                .build();

        irisPipeline.newRenderer(this::registerRenderer)
    ...
    private void svgfPipeline(IrisPipeline irisPipeline) {
        ...
        var temporalFramebuffer = irisPipeline.newFramebuffer(properties.getRenderScale(), this::registerComponent)
        ...
        var denoiseFramebuffer = irisPipeline.newFramebuffer(properties.getRenderScale(), this::registerComponent)
