...
import at.redi2go.photonics.engine.config.adapter.BlockAdapter;
import at.redi2go.photonics.engine.config.lights.LightRegistry;
import at.redi2go.photonics.engine.config.lights.LightsProvider;
import at.redi2go.photonics.engine.config.lights.block.LightBlock;
import at.redi2go.photonics.engine.config.lights.color.LightColor;
import at.redi2go.photonics.engine.config.lights.falloff.LightFalloff;
import at.redi2go.photonics.engine.config.lights.intensity.LightIntensity;
import at.redi2go.photonics.engine.config.lights.radius.LightRadius;
import at.redi2go.photonics.engine.util.Lazy;
