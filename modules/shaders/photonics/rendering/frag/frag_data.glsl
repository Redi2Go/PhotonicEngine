...
void frag_data_load(out FragData data, ivec2 texel) {
    frag.data0 = texelFetch(ph_frag_data0, texel, 0);
    frag.data1 = floatBitsToUint(ph_frag_data1, texel, 0);
}

void frag_data_load_previous(out FragData frag, ivec2 texel) {
    frag.data0 = texelFetch(prev_ph_frag_data0, texel, 0);
    frag.data1 = floatBitsToUint(prev_ph_frag_data1, texel, 0);
}
...
bool frag_is_in_world(FragData frag) {
